...
// Generated by CoffeeScript 1.6.3
var TOCTokens, TitleChooser, articleSelectorPaneHeight, articles, articlesDisplayOrder, boxH, calcEnd, calcStart, categorizedTextTree, colors, coreH, data, drawTitle, end, firstEntry, globalDims, layout, navBars, navBarsTree, panes, sceneDefine, sceneHook, sceneObject, sceneSync, segments, selectedArticle, session, start, states, subCategoriesNavigation, svgUtil, syncInit, textDraw, titleShow, tokenize, tokens, util, viewport, waitForData;
...
sceneDefine = function() {
  var TOC, downButton, fontSizeButton, mainPanes, navBarHook, rightPane, textPort, topPane;
  TOC = function() {
