...
// Generated by CoffeeScript 1.6.3
var TOCTokens, boxH, calcEnd, calcStart, categorizedText, colors, coreH, data, end, firstEntry, globalDims, layout, navBars, navBarsData, sceneDefine, sceneHook, sceneObject, sceneSync, segments, start, states, svgUtil, syncInit, textDraw, textporting, textportingAbstract, tokenize, tokens, util, viewport, waitForData;
...
data.get('text', function(response) {
  return categorizedText = JSON.parse(response).root;
});
...
waitForData = setInterval((function() {
  if ((tokens != null) && (TOCTokens != null) && (segments != null) && (navBarsData != null) && (categorizedText != null)) {
...
// Generated by CoffeeScript 1.6.3
var barUnselect, bars, colors, globalDims, layout, lookup, redraw, root, sceneObject, svgUtil, textRectFactory, util;
