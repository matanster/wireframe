...
// Generated by CoffeeScript 1.6.3
var TOCTokens, boxH, calcEnd, calcStart, categoriesOfSummary, data, end, firstEntry, globalDims, layout, sceneDefine, sceneSync, segments, start, states, svg, svgUtil, syncInit, textDraw, textporting, textportingAbstract, tokenize, tokens, totalH, util, viewport, waitForData;
...
waitForData = setInterval((function() {
  if ((categoriesOfSummary != null) && (tokens != null) && (TOCTokens != null) && (segments != null)) {
