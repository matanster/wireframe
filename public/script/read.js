...
// Generated by CoffeeScript 1.6.3
var barUnselect, bars, categorizedTextTree, colors, display, getCategoryText, globalDims, layout, lookup, redraw, root, sceneObject, searchCategories, svgUtil, textRectFactory, util;
...
display = function(bar) {
  ...
  if (textArray) {
    ...
    return console.dir(textArray);
  } else {
    return console.log('no text found for category...');
  }
};
