...
// Generated by CoffeeScript 1.6.3
var barUnselect, bars, categorizedTextTree, colors, getCategoryText, globalDims, layout, lookup, redraw, root, sceneObject, searchCategories, session, sessionSetDisplayType, svgUtil, textRectFactory, textportFluent, textportRefresh, textportSegmented, util;
...
textportRefresh = function(fontSizeChange, scroll, mode) {
  switch (session.display) {
    case 'segmented':
      return textportSegmented(session.selected, fontSizeChange, scroll, mode);
    case 'fluent':
      return textportFluent(session.selected, fontSizeChange, scroll, mode);
  }
};
...
},{"./globalDims":3,"./session":6,"./svgUtil":7,"./textportFluent":9,"./textportSegmented":10,"./util":12}],6:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
module.exports = {};
...
},{"./globalDims":3,"./textDraw":8}],10:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
...
},{"./globalDims":3,"./svgUtil":7,"./textDraw":8}],11:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
