...
sceneDefine = function() {
  ...
  titlePort = function() {
    ...
    sceneObject.titlePort.pane = sceneObject.titlePort.element.append('rect').style('fill', '#60CAFB');
    sceneObject.titlePort.textwrapper = sceneObject.titlePort.element.append('foreignObject').append('xhtml:body').html("<svg id='titleSVG' style='-webkit-transform: perspective(40px) rotateX(2deg)'></svg>");
    sceneObject.titlePort.textwrapper.style('pointer-events', 'none');
    sceneObject.titlePort.text = d3.select('#titleSVG').append('text').attr("id", "title").attr("dominant-baseline", "central").style("text-anchor", "middle").style('fill', "#EEEEEE");
...
sceneSync = function(mode) {
  ...
  drawTitle = function() {
    ...
    d3.select('#titleSVG').attr('width', viewport.width - 5 - 5 - 100).attr('height', articleSelectorPaneHeight);
...
},{"./data":1,"./globalDims":3,"./navBars":5,"./navBarsSubMode":6,"./session":7,"./svgUtil":8,"./textDraw":9,"./tokenize":12,"./util":13}],3:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
exports.layout = {};
...
},{"./globalDims":3,"./session":7,"./svgUtil":8,"./textportFluent":10,"./textportSegmented":11,"./tokenize":12,"./util":13}],6:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
var barUnselect, bars, categorizedTextTree, colors, getCategoryText, globalDims, layout, lookup, redraw, root, sceneObject, searchCategories, session, sessionSetDisplayType, svgUtil, textRectFactory, textportFluent, textportRefresh, textportSegmented, tokenize, util;
...
},{"./globalDims":3,"./session":7,"./svgUtil":8,"./textportFluent":10,"./textportSegmented":11,"./tokenize":12,"./util":13}],7:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
module.exports = {};
...
},{"./globalDims":3}],10:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
...
},{"./globalDims":3,"./session":7,"./textDraw":9,"./tokenize":12}],11:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
...
},{"./globalDims":3,"./session":7,"./svgUtil":8,"./textDraw":9}],12:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
var old;
